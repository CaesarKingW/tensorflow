...
// Defines the CLTimer type - the CL-specific implementation of the generic
// StreamExecutor Timer interface.

#ifndef TENSORFLOW_STREAM_EXECUTOR_CL_CL_TIMER_H_
#define TENSORFLOW_STREAM_EXECUTOR_CL_CL_TIMER_H_
...
class CLTimer : public internal::TimerInterface {
 public:
  explicit CLTimer(CLExecutor *parent)
