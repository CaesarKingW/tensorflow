...
#TEST_TMPDIR=/tmp/bazel/ bazel build ${LOCALRESOURCES} ${BUILDTYPE} -c dbg @protobuf_archive//:protoc
...
TEST_TMPDIR=/tmp/bazel/ bazel build ${LOCALRESOURCES} ${BUILDTYPE} -s -c dbg --verbose_failures  --logging 6 //tensorflow/tools/pip_package:build_pip_package
